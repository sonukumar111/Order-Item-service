package com.order.item.manage.api.doc;
...
@Component
@EnableSwagger2
public class OrderItemDocSwagger {
	...
	private static final Contact
	  CONTACT=new Contact("Support ","http://orderitem.support.in","supportforapi@altimetric.com");
	private static final String TITLE="Order Item Manager API";
	...
	public Docket apiVersion1_0() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.order.item.manage.controller"))
				.build()
